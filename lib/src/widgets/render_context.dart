...
/// Registry of all [RenderEditableProxyBox]es inside a [EditorEditableText].
///
/// Provides access to all currently active [RenderEditableProxyBox]
/// instances of a [EditorEditableText].
///
...
class EditorRenderContext extends ChangeNotifier {
