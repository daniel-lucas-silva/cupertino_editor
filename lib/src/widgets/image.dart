...
/// Provides interface for embedding images into Editor editor.
// TODO: allow configuring image sources and related toolbar buttons.
@experimental
abstract class EditorImageDelegate<S> {
...
class EditorImage extends StatefulWidget {
  const EditorImage({Key key, @required this.node, @required this.delegate})
      : super(key: key);

  final EmbedNode node;
  final EditorImageDelegate delegate;

  @override
  _EditorImageState createState() => _EditorImageState();
}
