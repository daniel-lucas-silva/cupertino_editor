...
/// Controls level of interactions allowed by Editor editor.
///
...
class EditorMode {
  ...
  static const edit =
      EditorMode(canEdit: true, canSelect: true, canFormat: true);
  ...
  /// Creates new mode which describes allowed interactions in Editor editor.
  const EditorMode({
  ...
  bool operator ==(Object other) {
    ...
    if (other is! EditorMode) return false;
    final EditorMode that = other;
  ...
  @override
  String toString() {
    return 'EditorMode(canEdit: $canEdit, canSelect: $canSelect, canFormat: $canFormat)';
  }
}
