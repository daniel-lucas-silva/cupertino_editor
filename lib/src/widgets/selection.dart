...
class EditorSelectionOverlay extends StatefulWidget {
  const EditorSelectionOverlay({Key key, @required this.controls})
      : super(key: key);

  final TextSelectionControls controls;

  @override
  EditorSelectionOverlayState createState() => EditorSelectionOverlayState();
}

class EditorSelectionOverlayState extends State<EditorSelectionOverlay>
...
class SelectionHandleDriver extends StatefulWidget {
  ...
  final EditorSelectionOverlayState selectionOverlay;
...
class _SelectionHandleDriverState extends State<SelectionHandleDriver>
  ...
  Widget build(BuildContext context) {
    ...
    final interactiveRect = handleRect.expandToInclude(
      Rect.fromCircle(center: handleRect.center, radius: 48 / 2),
    );
...
class _SelectionToolbarState extends State<_SelectionToolbar> {
  ...
  EditorScope get scope => widget.selectionOverlay.scope;
