...
import 'package:cupertino_editor/src/widgets/buttons.dart';
...
void main() {
  ...
  group('$HeadingButton', () {
    testWidgets('toggle menu', (tester) async {
      ...
      expect(h1.action, EditorToolbarAction.headingLevel1);
      var h2 = editor.findButtonWithText('H2');
      expect(h2.action, EditorToolbarAction.headingLevel2);
      var h3 = editor.findButtonWithText('H3');
      expect(h3.action, EditorToolbarAction.headingLevel3);
    });
  ...
  group('$LinkButton', () {
    ...
    testWidgets('editing link', (tester) async {
      ...
      expect(find.widgetWithText(EditorToolbarScaffold, 'https://github.com'),
          findsOneWidget);
      LineNode line = editor.document.root.children.first;
      expect(line.childCount, 3);
