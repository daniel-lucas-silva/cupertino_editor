...
void main() {
  group('$EditorEditor', () {
    testWidgets('allows merging attribute theme data', (tester) async {
      ...
      var theme = EditorThemeData(attributeTheme: attributeTheme);
      ...
      final p =
          tester.widget(find.byType(EditorRichText).first) as EditorRichText;
    ...
    testWidgets('toggle enabled state', (tester) async {
      ...
      final widget = tester.widget(find.byType(EditorEditor)) as EditorEditor;
      expect(widget.mode, EditorMode.view);
    });
